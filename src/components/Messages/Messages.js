...
function Messages() {
    ...
    return (
        <div className='chatbox'>
            ...
            <img className='chatbox__nav-back-arrow' onClick={() => {history.push('/')}} src={backArrow} />
            <img className='chatbox__nav-avatar' src={avatar1} />
            ...
            <div className='chatbox__input'>
                ...
                <img className='chatbox__input-submit' src={sendIcon}/>
                </div>
            </div>
        </div>
    )
